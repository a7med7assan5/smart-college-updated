...
class teacherService {
    ...
    static addLecture(courseCode, semester_time, lectureNumber, routerAddress) {
        var lecture = { lectureNumber, routerAddress };
    ...
    static addSemesterAttendance(studentId, courseId, semester_time, lectureNumber, routerAddress) {
        const newAttendance = new Attendance({ studentId, courseId, semester_time, lectureNumber, routerAddress });
    ...
    static attendme(studentId, courseId, semester_time, lectureNumber, routerAddress) {
        return Attendance.findOne({ studentId, courseId, semester_time, lectureNumber, routerAddress }).updateOne(
            {},
            { $set: { status: true } },
            { multi: true }
        )

...
router.post('/add/user/course/:id/:sender', adminController.addUserCourse);
...
router.get('/routers', adminController.getAllRouters);
...
router.delete('/delete/router/:locationId', adminController.deleteRouter);
